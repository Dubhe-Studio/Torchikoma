...
public class FollowOwnerGoal extends Goal {
    ...
    private final TorchikomaEntity tamable;
    ...
    public FollowOwnerGoal(TorchikomaEntity pTamable, double pSpeedModifier, float pStartDistance, float pStopDistance, boolean pCanFly) {
