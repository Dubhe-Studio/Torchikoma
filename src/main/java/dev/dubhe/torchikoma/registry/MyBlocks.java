...
public class MyBlocks {
    ...
    public static final Block PRISMARINE_WALL_TORCH = new TorchBlock(defaultProperties(Material.DECORATION)
    ...
    public static final Block GLOWSTONE_WALL_TORCH = new TorchBlock(defaultProperties(Material.DECORATION)
